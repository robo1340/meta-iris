...
def create_hostapd_conf(attributes, path='/tmp/hostapd.conf'):
	...
	HOSTAPD_ALLOWED_OPTIONS = ["interface","hw_mode","channel","ieee80211d","country_code","ieee80211n","wmm_enabled","ssid","auth_algs","wpa","wpa_key_mgmt","rsn_pairwise","wpa_passphrase","ignore_broadcast_ssid","macaddr_acl"]
...
parser.add_argument('-p', '--passphrase', type=str, default='', help = 'the wifi AP passphrase')
...
if __name__ == "__main__":
	...
	if (config['passphrase'] == ''): 
		hostapd_conf['ignore_broadcast_ssid'] = 0
		hostapd_conf['macaddr_acl'] = 0
	else:
		hostapd_conf['wpa_passphrase']	= config['passphrase']
		hostapd_conf['wpa']				= 2
